        ...
        self.loadSourceCodeTab = function (url) {
            ...
            $.ajax({
                ...
                success: function (data) {
					...
					$("<span>").attr("id", "copyclipboard").addClass("copyedit copycode").attr('title','Copy To Clipboard').appendTo($("#sourceTab .e-header"));
					...
					$("<span>").attr("id", "EditWindow").addClass("copyedit").attr('title','Edit in JS Playground').appendTo($("#sourceTab .e-header"));
                    $("<span>").attr("id","Editicon").addClass("e-icon e-select newsrcwindow").appendTo("#EditWindow");
					$("<span>").attr("id","EditText").text("Edit").addClass("copyeditText").appendTo("#EditWindow");
